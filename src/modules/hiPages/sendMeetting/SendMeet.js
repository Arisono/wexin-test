...
export default class SendMeet extends Component{
    ...
    render(){
        let headerArray = [1,2,3,4];
        return(
            <div >
                <div onChange={this.handelValueCom}>
                    <textarea ref='meetTitle' className="form-control textarea_sty" rows="2" placeholder="请填写会议主题…" ></textarea>
                    ...
                    <div  className="item_sty">
                        ...
                        <div className="text-right" style={{width:"100%",}}>
                            <div>
                                <Select defaultValue="请选择" style={{ width:'auto' }} onChange={this.handleSelectChange}>
                    ...
                    <div className="meet_penson">
                        {headerArray.map((itemata,index) => <Test key={index} itemata = {itemata}></Test>)}
                    </div>
